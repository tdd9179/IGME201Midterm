    ...
    class Program
    {
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                {
                    nAnswer = val1 / val2;
                    // convert int variables to doubles
                    double dAnswer1 = Convert.ToDouble(val1);
                    double dAnswer2 = Convert.ToDouble(val2);
                    dAnswer1 = Math.Round(dAnswer1, 2);
                    dAnswer2 = Math.Round(dAnswer2, 2);
                    sQuestions = $"Question #{nCntr + 1}: {dAnswer1} / {dAnswer2} => ";
                }
                else
                {
                    nAnswer = val1 * val2;
